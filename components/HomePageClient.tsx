        ...
        <div className="mt-8 max-w-md mx-auto sm:flex sm:justify-center md:mt-10">
          {isAuthenticated ? (
            <div className="space-y-3 sm:space-y-0 sm:space-x-3 sm:flex">
              <Link href="/challenges" className="inline-flex items-center px-8 py-3 border border-transparent text-lg font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-xl transition-shadow">
                🎯 Start Challenges
              </Link>
              <Link href="/profile" className="inline-flex items-center px-8 py-3 border border-gray-300 text-lg font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                👤 My Profile
              </Link>
            </div>
          ) : (
            <div className="space-y-3 sm:space-y-0 sm:space-x-3 sm:flex">
              <Link href="/auth/signup" className="inline-flex items-center px-8 py-3 border border-transparent text-lg font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-xl transition-shadow">
                🚀 Get Started
              </Link>
              <Link href="/auth/signin" className="inline-flex items-center px-8 py-3 border border-gray-300 text-lg font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                🔐 Sign In
              </Link>
            </div>
          )}
        ...
        <div className="mt-20">
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">{user.score || 0}</div>
