...
interface OptimizedChallengeCardProps {
  challenge: ChallengeWithSolved
  showDescription?: boolean
  showSubmissionForm?: boolean
}

const OptimizedChallengeCard = memo(function OptimizedChallengeCard({ 
  challenge, 
  showDescription = false, 
  showSubmissionForm = true 
}: OptimizedChallengeCardProps) {
...
export default OptimizedChallengeCard
